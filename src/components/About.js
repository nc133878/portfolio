 ...
 function About(){
    return(
        <section className='about-section'>
            ...
            <p> As a seasoned developer with over 6+ years of experience, I have a proven track record of delivering high-quality, scalable, and efficient applications. I have a particular interest in developing costumer facing solutions using frontend frameworks.  
